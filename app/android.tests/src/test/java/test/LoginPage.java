...
public class LoginPage {
	...
	//constructor to initialize LoginPage Class with IOSDriver with pageFactory design pattern
	   ...
	   public LoginPage(AppiumDriver<MobileElement> driver) {
		...
		//	wait.until(ExpectedConditions.elementToBeClickable(By.id("uk.org.humanfocus.hfi:id/date_ll")));
			

			MobileElement el1 = (MobileElement) driver.findElementById("uk.org.humanfocus.hfi:id/date_ll");
			el1.click();
			//el1.click();
			//el1.click();
