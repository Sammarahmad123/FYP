...
//		}
		...
		public boolean verifyFailWith33Score() throws InterruptedException
		{
			...
			if(score==33.33333333333333 && text.contains("Fail"))
			{
				return true;
			}
			else
		...
		public boolean verifyPasswith100Score() throws InterruptedException
		{
		 ...
		 /**
		    ...
		    */
			...
			@FindBy(id = "uk.org.humanfocus.hfi:id/ll_dateTimeClick")
		    public MobileElement date_n_time_questions;
