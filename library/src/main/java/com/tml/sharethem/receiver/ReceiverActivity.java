...
public class ReceiverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        receivedFiles = findViewById(R.id.Receivedfiles);
        ...
        receivedFiles.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent chooser = new Intent(Intent.ACTION_GET_CONTENT);
                Uri uri = Uri.parse(Environment.getDownloadCacheDirectory().getPath()+"/StudyMate");
                ...
                {
                    Toast.makeText(ReceiverActivity.this, "Please install a File Manager.",Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void onResume() {
        ...
        if (isConnectedToShareThemAp) {
            ...
            Log.d(TAG, "wifi is connected/connecting to StudyMate ap, ssid: " + ssid);
            mConnectedSSID = ssid;
            addSenderFilesListingFragment(WifiUtils.getAccessPointIpAddress(this), ssid);
        } else if (m_receiver_control.isChecked()) {
            Log.d(TAG, "wifi isn't connected to StudyMate ap, initiating sender search..");
            resetSenderSearch();
        }
    }
...
//                R.anim.push_right_in, R.anim.push_right_out);
    ...
    private String[] setConnectedUi(String ssid) {
        ...
        receivedFiles.setVisibility(View.VISIBLE);
        return senderInfo;
    }
    ...
    private void removeSenderFilesListingFragmentIfExists() {
        ...
        //receivedFiles.setVisibility(View.GONE);
        Fragment fragment = getSupportFragmentManager().findFragmentByTag(TAG_SENDER_FILES_LISTING);
        if (null != fragment)
