...
public class FilesListingFragment extends android.support.v4.app.Fragment {
    ...
    private long postDownloadRequestToDM(Uri uri, String fileName) {
        ...
        request.setDescription("StudyMate");
        request.setNotificationVisibility(DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED);

        //Set the local destination for the downloaded file to a path
        //within the application's external files directory
//        File dir = new File(Environment.getExternalStorageDirectory()+"/StudyMate/Received");
//        if(!dir.exists())
//            dir.mkdirs();
        request.setDestinationInExternalPublicDir("/StudyMate/Received/", fileName);
